...
int main() {
    ...
    case 1:
        ...
        if (pop1 > pop2 || pop1 < pop2) {
            ...
            printf("em termos de população.\n");
        } else if (pop1 == pop2) {
            printf("Empate!\n");
            printf("Não há um vencedor em termos de população.\n");
            }
        break;
    case 2:
        printf("%s vs %s\n", estado1, estado2);
        ...
        if (area1 > area2 || area1 < area2) {
            printf("O %s venceu o %s\n", estado1, estado2);
            printf("em termos de área.\n");
            } else if (area1 == area2) {
            printf("Empate!\n");
            printf("Não há um vencedor em termos de área.\n");
            }
        break;
    case 3:
        printf("%s vs %s\n", estado1, estado2);
        ...
        if (pib1 > pib2 || pib1 < pib2) {
            printf("O %s venceu o %s\n", estado1, estado2);
            printf("em termos de PIB.\n");
            } else if (pib1 == pib2) {
            printf("Empate\n");
            printf("Não há um vencedor em termos de PIB\n");
            }
        break;
    case 4:
        printf("%s vs %s\n", estado1, estado2);
        ...
        if (pontos_turisticos1 > pontos_turisticos2 || pontos_turisticos1 < pontos_turisticos2) {
            printf("O %s venceu o %s\n", estado1, estado2);
            printf("em termos de pontos turísticos.\n");
            } else if (pontos_turisticos1 == pontos_turisticos2) {
            printf("Empate!\n");
            printf("Não há um vencedor em termos de pontos turísticos.\n");
            }
        break;
    case 5:
        printf("%s vs %s\n", estado1, estado2);
        ...
        printf("Comparação: %.2f vs %.2f\n", DP1, DP2);
        if (DP1 > DP2 || DP1 < DP2) {
            printf("O %s venceu o %s", estado1, estado2);
            printf("em termos de densidade populacional.\n");
            } else if (DP1 == DP2) {
            printf("Empate!\n");
            printf("Não ha um vencedor em termos de densidade populacional\n");
            }
        break;
    default:
